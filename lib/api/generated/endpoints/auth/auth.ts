...
export const useAuthControllerTelegramAuth = <TError = ErrorType<void>,
 ...
 , queryClient?: QueryClient): UseMutationResult<
    ...
    /**
 * @summary Вход через Telegram Login Widget (браузер)
 */
export const authControllerWidgetAuth = (
    telegramWidgetDto: BodyType<TelegramWidgetDto>,
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
) => {


      return customInstance<AuthResponseDto>(
      {url: `/api/v1/auth/telegram/widget`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: telegramWidgetDto, signal
    },
      options);
    }
...
export const getAuthControllerWidgetAuthMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof authControllerWidgetAuth>>, TError,{data: BodyType<TelegramWidgetDto>}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof authControllerWidgetAuth>>, TError,{data: BodyType<TelegramWidgetDto>}, TContext> => {

const mutationKey = ['authControllerWidgetAuth'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof authControllerWidgetAuth>>, {data: BodyType<TelegramWidgetDto>}> = (props) => {
          const {data} = props ?? {};

          return  authControllerWidgetAuth(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AuthControllerWidgetAuthMutationResult = NonNullable<Awaited<ReturnType<typeof authControllerWidgetAuth>>>
    export type AuthControllerWidgetAuthMutationBody = BodyType<TelegramWidgetDto>
    export type AuthControllerWidgetAuthMutationError = ErrorType<void>

    /**
 * @summary Вход через Telegram Login Widget (браузер)
 */
export const useAuthControllerWidgetAuth = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof authControllerWidgetAuth>>, TError,{data: BodyType<TelegramWidgetDto>}, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof authControllerWidgetAuth>>,
        TError,
        {data: BodyType<TelegramWidgetDto>},
        TContext
      > => {
      return useMutation(getAuthControllerWidgetAuthMutationOptions(options), queryClient);
    }
    /**
