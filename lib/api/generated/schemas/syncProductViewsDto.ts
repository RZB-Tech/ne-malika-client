 ...
 */
import type { SyncProductViewItemDto } from './syncProductViewItemDto';

export interface SyncProductViewsDto {
  /** Локальная история устройства; лишнее клиент отсекает сам */
