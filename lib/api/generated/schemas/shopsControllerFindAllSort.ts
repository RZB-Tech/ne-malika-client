...
export type ShopsControllerFindAllSort = typeof ShopsControllerFindAllSort[keyof typeof ShopsControllerFindAllSort];


export const ShopsControllerFindAllSort = {
  products: 'products',
  rating: 'rating',
  newest: 'newest',
  name: 'name',
