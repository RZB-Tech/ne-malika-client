...
export type AdminShopBannersControllerListStatus = typeof AdminShopBannersControllerListStatus[keyof typeof AdminShopBannersControllerListStatus];


export const AdminShopBannersControllerListStatus = {
  pending: 'pending',
  approved: 'approved',
  rejected: 'rejected',
} as const;
