...
export type SubscriptionPaymentDtoStatus = typeof SubscriptionPaymentDtoStatus[keyof typeof SubscriptionPaymentDtoStatus];


export const SubscriptionPaymentDtoStatus = {
  pending: 'pending',
  prepared: 'prepared',
  paid: 'paid',
  cancelled: 'cancelled',
