 ...
 */
import type { SubscriptionProviderSliceDtoProvider } from './subscriptionProviderSliceDtoProvider';

export interface SubscriptionProviderSliceDto {
  provider: SubscriptionProviderSliceDtoProvider;
  /** Оплат за период */
  payments: number;
