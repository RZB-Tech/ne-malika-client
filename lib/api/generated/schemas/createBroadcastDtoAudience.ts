...
export type CreateBroadcastDtoAudience = typeof CreateBroadcastDtoAudience[keyof typeof CreateBroadcastDtoAudience];


export const CreateBroadcastDtoAudience = {
  all: 'all',
  sellers: 'sellers',
  buyers: 'buyers',
} as const;
