 ...
 */
import type { SubscriptionActivePlanDtoPlan } from './subscriptionActivePlanDtoPlan';

export interface SubscriptionActivePlanDto {
  plan: SubscriptionActivePlanDtoPlan;
  /** Магазинов с действующей подпиской */
  shops: number;
}
