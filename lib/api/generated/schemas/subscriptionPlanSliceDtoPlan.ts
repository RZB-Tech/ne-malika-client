...
export type SubscriptionPlanSliceDtoPlan = typeof SubscriptionPlanSliceDtoPlan[keyof typeof SubscriptionPlanSliceDtoPlan];


export const SubscriptionPlanSliceDtoPlan = {
  start: 'start',
  pro: 'pro',
  max: 'max',
} as const;
