...
export type SubscriptionPaymentDtoProvider = typeof SubscriptionPaymentDtoProvider[keyof typeof SubscriptionPaymentDtoProvider];


export const SubscriptionPaymentDtoProvider = {
  click: 'click',
  payme: 'payme',
  manual: 'manual',
} as const;
