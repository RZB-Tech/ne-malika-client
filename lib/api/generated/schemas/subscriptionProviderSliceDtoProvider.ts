...
export type SubscriptionProviderSliceDtoProvider = typeof SubscriptionProviderSliceDtoProvider[keyof typeof SubscriptionProviderSliceDtoProvider];


export const SubscriptionProviderSliceDtoProvider = {
  click: 'click',
  payme: 'payme',
  manual: 'manual',
} as const;
