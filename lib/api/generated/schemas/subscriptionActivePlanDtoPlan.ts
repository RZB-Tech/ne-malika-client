...
export type SubscriptionActivePlanDtoPlan = typeof SubscriptionActivePlanDtoPlan[keyof typeof SubscriptionActivePlanDtoPlan];


export const SubscriptionActivePlanDtoPlan = {
  start: 'start',
  pro: 'pro',
  max: 'max',
} as const;
