...
export type AdminSubscriptionsControllerListPlan = typeof AdminSubscriptionsControllerListPlan[keyof typeof AdminSubscriptionsControllerListPlan];


export const AdminSubscriptionsControllerListPlan = {
  free: 'free',
  start: 'start',
  pro: 'pro',
  max: 'max',
