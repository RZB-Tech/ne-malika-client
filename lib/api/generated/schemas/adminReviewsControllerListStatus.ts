...
export type AdminReviewsControllerListStatus = typeof AdminReviewsControllerListStatus[keyof typeof AdminReviewsControllerListStatus];


export const AdminReviewsControllerListStatus = {
  pending: 'pending',
  approved: 'approved',
  rejected: 'rejected',
} as const;
