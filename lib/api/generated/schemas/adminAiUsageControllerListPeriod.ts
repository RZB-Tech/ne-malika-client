...
export type AdminAiUsageControllerListPeriod = typeof AdminAiUsageControllerListPeriod[keyof typeof AdminAiUsageControllerListPeriod];


export const AdminAiUsageControllerListPeriod = {
  all: 'all',
  today: 'today',
  '7d': '7d',
  '30d': '30d',
