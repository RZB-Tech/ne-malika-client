...
/**
 * Часы и минуты без даты — для сроков, которые истекают в пределах часа.
 *
 * Дата в таком сроке не помогает, а мешает: «27 авг. 14:35» читается дольше,
 * чем «14:35», и заставляет проверять, не завтрашнее ли это число, хотя окно
 * живёт полчаса. Там, где срок может перевалить за сутки, нужен `formatDate`.
 */
